  ...
  private function _login()
  {
    ...
    if ($user) {
      ...
      if (password_verify($pass, $user['password'])) {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-danger" role="alert">Password salah, Silahkan coba lagi!</div>'); //buat pesan akun tidak ada
        redirect('auth');
      }
    } else {
      // usernya ga ada
      $this->session->set_flashdata('pesan', '<div class="alert alert-danger" role="alert">User tidak ditemukan. Silahkan membuat akun terlebih dahulu!</div>'); //buat pesan akun tidak ada
      redirect('auth');
    }
  }
